    ...
    >
      <div className="space-y-4 text-center">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#DCFCE7]">
          <SidebarIcon icon="dashboards" className="h-8 w-8 text-[#00A63E]" />
        </div>
        <h1 className="text-3xl font-bold text-[#101828]">Dashboards</h1>
        <p className="text-sm text-[#6A7282]">Aquí encontrarás reportes visuales y análisis del sistema.</p>
